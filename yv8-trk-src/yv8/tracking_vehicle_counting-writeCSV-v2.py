...
#usps
# python tracking_vehicle_counting-writeCSV.py mode="pedict" model=yolov8x.pt source=/media/zubin/Stuff1/DATA/TRANSPORT/IR-sample-data/9.BATCH_1/ID373-202303211345to202303231030/100_compressed_vid/03210003.MOV conf=0.55 show=True agnostic_nms=0.4 cls=[0,1,2,3,5,7] line_thickness=1
#374E-03210007.MOV

#4.kids
# python tracking_vehicle_counting-writeCSV.py mode="pedict" model=yolov8s.pt source=/media/zubin/Stuff1/DATA/TRANSPORT/IR-sample-data/9.BATCH_1/ID373-202303211345to202303231030/100_compressed_vid/03210003.MOV conf=0.55 show=True agnostic_nms=0.4 cls=[0,1,2,3,5,7] line_thickness=1
...
def predict(cfg):
    ...
    if os.path.isfile(mask_file_loc):
        ...
        x_l_im = r.shape[1] #width of image, 1280
        y_l_im = r.shape[0] #height, 720
