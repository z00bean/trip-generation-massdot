# v4 THERM Exactly same as v4, except output folder structure changed.
...
# python tracking_vehicle_counting-writeCSV-v4-THERM.py mode="pedict" model=yolov8s.pt source=/media/zubin/Stuff1/DATA/TRANSPORT/IR-sample-data/9.BATCH_1/ID373-202303211345to202303231030/100_compressed_vid/03210003.MOV conf=0.55 show=True agnostic_nms=0.4 cls=[0,1,2,3,5,7] line_thickness=1
...
def draw_boxes(img, f_no, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    img = cv2.rectangle(img, (0, 0), (850,150), (0,0,0), -1) #left top ##changed 235 to 850
